...
#Generate network. Here we use a two-layer ls-lstm network to
#leverage the nonlinearity here
################################################################################
layer_1 = linear_surrogate_lstm(x, n_hidden, name='ls-lstm')
outputs = linear_surrogate_lstm(layer_1, n_hidden, name='ls-lstm')
